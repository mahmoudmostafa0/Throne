...
namespace Throne.Framework.Math
{
    public class BigInteger
    {
        ...
        private static readonly FastRandom RandomSource = new FastRandom();
            ...
            int[] y)
        {
            ...
            Contract.Assert(yStart < y.Length);
        ...
        private bool CheckProbablePrime(
            ...
            FastRandom random)
        {
            Contract.Assert(certainty > 0);
            Contract.Assert(CompareTo(Two) > 0);
            Contract.Assert(TestBit(0));
            ...
            int[] x)
        {
            ...
            {
                Contract.Assert((uint) (u2 + (u1 >> 32)) == 0);
            }
            ...
            BigInteger n)
        {
            ...
            if (n.magnitude.Length == 1)
            {
                ...
                if (val > 0)
                {
                    ...
                    return rem == 0
                        ? Zero
                        : new BigInteger(sign, new[] {rem}, false);
                }
            }
        ...
        {
            Contract.Assert(yStart < y.Length);
            Contract.Assert(x.Length - xStart >= y.Length - yStart);
            ...
            int radix)
        {
            ...
            Contract.Assert(magnitude.Length > 0);
