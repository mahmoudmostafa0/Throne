...
namespace Throne.Shared.Commands
{
    public class CommandArguments
    {
        ...
        public Boolean TargetedCommand;

        public CommandArguments(IEnumerable<string> args, Boolean targetCommand = false)
        {
            _enum = args.GetEnumerator();
            TargetedCommand = targetCommand;
        }

        public Color NextColor(KnownColor? def = null)
        {
            return Color.FromKnownColor(NextEnum<KnownColor>(def));
        }
