...
----
 ...
 - Login
   - Type >help ingame for commands, or help on the console.
   - Use >> to activate targeted commands, any user command can be used on a target. Usage: >>teleport Mentalis 1002 300 378
